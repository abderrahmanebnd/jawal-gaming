...
const GameCard = memo(({ 
  ...
  const favoriteButtonStyles = useMemo(() => ({
    ...
    transform: isHovered && isFavorited ? 'scale(1.1)' : 'scale(1)'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          {inTopGames && typeof game.liked === 'number' && (
            <div
              className="position-absolute top-2 start-2 d-flex align-items-center gap-1 px-2 py-1 rounded-pill"
              style={{
      ...
      {/* Game Title (Outside Link for Better SEO) */}
