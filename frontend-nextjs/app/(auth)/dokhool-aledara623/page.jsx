...
import FooterComponent from "@/features/dashboard/components/FooterComponent";

export const metadata = {
  title: "Admin Dashboard - Jawal Gaming",
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.background =
                  "linear-gradient(45deg, #e74c3c, #dc3545)";
              }}
              onMouseLeave={(e) => {
                  ...
                  <div className="text-center">
                    ...
                    >
                      <small style={{ color: "#dc3545" }}>
                        ...
                        You will need to log in again to access the admin
                        dashboard.
                      </small>
                    </div>
                  </div>
