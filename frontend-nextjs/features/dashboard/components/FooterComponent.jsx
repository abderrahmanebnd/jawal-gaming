        ...
        <div className="col-12">
          <div className="d-flex align-items-center justify-content-between mb-4">
            <div className="mt-4">
              ...
              >
                Configure your website footer navigation
              </p>
            </div>
            {FooterLoading && (
          ...
          {footerLinks.length === 0 && !FooterLoading ? (
            <div className="text-center py-5">
              <LinkIcon size={64} color="#6c757d" className="mb-3 mx-auto" />
              <h5 className="text-muted">No footer links yet</h5>
              <p className="text-muted">
                Add your first footer link by clicking the button above
              </p>
              <button
                ...
                <div className="d-flex align-items-center">
                  <div
                    ...
                    style={{
                      width: "40px",
                      height: "40px",
                      backgroundColor: editingFooterLink
                        ? "#ffc107"
            ...
            >
              ...
              <div className="modal-body px-4 py-3">
                <div className="text-center mb-3">
                  ...
                  <p
                    className="text-white mb-1 small"
                    style={{ wordBreak: "break-all" }}
                  >
                    {linkToDelete.url}
                  </p>
                  <p className="text-white mb-3" style={{ fontSize: "0.9rem" }}>
                    Are you sure you want to delete this footer link? This
                  ...
                  >
                    <small className="text-danger">
                      ...
                      This will permanently remove the link from your footer
                      navigation.
                    </small>
                  </div>
                </div>
