      ...
      >
        ...
        <button 
          ...
          style={{ 
            ...
            boxShadow: isFavorited ? '0 4px 12px rgba(220, 53, 69, 0.4)' : '0 2px 8px rgba(0,0,0,0.3)'
          }}
          onClick={(e) => {
            e.stopPropagation();
        ...
        >
          <Heart 
            ...
            style={{ 
              ...
              filter: isFavorited ? 'drop-shadow(0 1px 2px rgba(0,0,0,0.5))' : 'none'
            }}
          />
        </button>
        ...
        <div 
          ...
          style={{
            width: '80px',
            height: '80px',
            background: 'radial-gradient(circle at top right, rgba(0,0,0,0.4) 0%, transparent 70%)',
        ...
        <div 
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.opacity = '1';
            // Show play button
            const playButton = e.currentTarget.parentElement.querySelector('.translate-middle');
            if (playButton) {
